...
import 'package:bizlify/screens/GoToPickupScreen/components/start_delivery_sheet.dart';
import 'package:flutter/material.dart';
import 'package:flutter_screenutil/flutter_screenutil.dart';
import 'package:slide_action/slide_action.dart';

class GoToPickupSheet extends StatefulWidget {
  const GoToPickupSheet({super.key});

  @override
  State<GoToPickupSheet> createState() => _GoToPickupSheetState();
}

class _GoToPickupSheetState extends State<GoToPickupSheet> {
  @override
